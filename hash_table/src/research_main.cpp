...
int main(int argc, char *argv[]) {
  ...
  hash_info_t hashes[] = {
      {"one_hash", one_hash},         {"first_ascii_hash", first_ascii_hash},
      {"lenth_hash", lenth_hash},     {"ascii_sum_hash", ascii_sum_hash},
      {"hash_rol_xor", hash_rol_xor}, {"gnu_hash", gnu_hash},
  ...
  for (int i = 0; i < n_hashes; i++) {
    ...
    char csv_name[128] = "";
    snprintf(csv_name, sizeof(csv_name), "results/tables/%s.csv",
             hashes[i].name);
